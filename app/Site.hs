...
main = hakyll $ do
    ...
    match "site-src/static/*.markdown" staticMarkdownRule
...
feedConfig = FeedConfiguration {
        feedTitle       = "oscarvarto's feed",
        feedDescription = "Software, Mobile",
        feedAuthorName  = "Oscar Vargas Torres",
        feedAuthorEmail = "vargas.torres.oscar@gmail.com",
        feedRoot        = "http://127.0.0.1:8000"
    }
...
pandocMathWriterOptions  = defaultHakyllWriterOptions {
        ...
        writerHTMLMathMethod = MathJax "/MathJax/MathJax.js"
}
